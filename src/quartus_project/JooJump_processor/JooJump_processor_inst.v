	JooJump_processor u0 (
		...
		.lcd_data_1_lcd_data     (<connected-to-lcd_data_1_lcd_data>),     //   lcd_data_1.lcd_data
		.lcd_enable_lcd_enable   (<connected-to-lcd_enable_lcd_enable>),   //   lcd_enable.lcd_enable
		.lcd_enable_1_lcd_enable (<connected-to-lcd_enable_1_lcd_enable>), // lcd_enable_1.lcd_enable
		.lcd_rs_lcd_rs           (<connected-to-lcd_rs_lcd_rs>),           //       lcd_rs.lcd_rs
		.lcd_rs_1_lcd_rs         (<connected-to-lcd_rs_1_lcd_rs>),         //     lcd_rs_1.lcd_rs
		.lcd_rw_lcd_rw           (<connected-to-lcd_rw_lcd_rw>),           //       lcd_rw.lcd_rw
		.lcd_rw_1_lcd_rw         (<connected-to-lcd_rw_1_lcd_rw>),         //     lcd_rw_1.lcd_rw
